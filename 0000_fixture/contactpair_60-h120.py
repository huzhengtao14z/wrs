...
if __name__=='__main__':
    ...
    base = wd.World(cam_pos=[0.131, 0.274, -0.34], w=960, h=540, lookat_pos=[0, 0, 0.0])
    ...
    fixturepath = os.path.join(this_dir, "objects", "v60.STL")
    ...
    def update(textNode, obj_show_node, counter, task):
        if base.inputmgr.keymap['space'] is True:
            ...
            obj_show_node[0].set_rgba((0, 191 / 255, 1, 0.2))
