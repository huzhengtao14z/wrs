...
if __name__ == '__main__':
    ...
    #         matrix[y][x] = matrix[y][x] + offset_matrix[y][x]
            ...
            #     matrix[y][x] = matrix[y][x] + np.array([0, 0, -0.003-0.001])
    #left right
    c1 = cm.gen_box(extent=[.006*18.5, 0.006*8, .001], homomat=rm.homomat_from_posrot([0.006*22, 0.006*9  ,0], rm.rotmat_from_axangle([0,0,1], 0*np.pi/2)),rgba=[0,0,0,0.2])
    c2 = cm.gen_box(extent=[.006*18.5, 0.006*8, .001], homomat=rm.homomat_from_posrot([0.006*22, 0.006*29  ,0], rm.rotmat_from_axangle([0,0,1], 0*np.pi/2)),rgba=[0,0,0,0.2])
    #top down
    c3 = cm.gen_box(extent=[.006*4   , 0.006*28.5, .001], homomat=rm.homomat_from_posrot([0.006*3.5 , 0.006*19,0], rm.rotmat_from_axangle([0,0,1], 0*np.pi/2)), rgba=[0,0,0,0.2])
    c4 = cm.gen_box(extent=[.006 * 4, 0.006 * 28.5, .001], homomat=rm.homomat_from_posrot([0.006 * (33+3.5+4), 0.006 * 19, 0], rm.rotmat_from_axangle( [0, 0, 1], 0 * np.pi / 2)), rgba=[0, 0, 0, 0.2])
    #center
    c5 = cm.gen_box(extent=[.006 * 11, 0.006 * 15, .001], homomat=rm.homomat_from_posrot([0.006 * (17 + 5.5), 0.006 * 4, 0], rm.rotmat_from_axangle([0, 0, 1], 0 * np.pi / 2)), rgba=[0, 0, 0, 0.2])
    c6 = cm.gen_box(extent=[.006 * 11, 0.006 * 15, .001],
                    homomat=rm.homomat_from_posrot([0.006 * (17 + 5.5), 0.006 * 37, 0],
                                                   rm.rotmat_from_axangle([0, 0, 1], 0 * np.pi / 2)),
                    rgba=[0, 0, 0, 0.2])
    # bottom
    #bottom
    c7 = cm.gen_box(extent=[.006 * 4, 0.006 * 43, .001],
                    homomat=rm.homomat_from_posrot([0.006 * (45), 0.006 * 23.5, 0],
                                                   rm.rotmat_from_axangle([0, 0, 1], 0 * np.pi / 2)),
                    rgba=[0, 0, 0, 0.2])

    c8 = cm.gen_box(extent=[.006 * 50, 0.006 * 8, .001], homomat=rm.homomat_from_posrot([0.006 * 22, 0.006 * 41, 0],
