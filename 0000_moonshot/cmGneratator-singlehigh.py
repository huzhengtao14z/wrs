...
if __name__ == '__main__':
    ...
    node = Node(grid, height=0.012, origin_offset=0.002)
    matrix_infos = node.node_matrix_infos
    for key in matrix_infos.keys():
        element = Element(matrix_infos[key], dict="thin",radius=0.0012, id = key, cut = cut_list, support = False, secondlayer = False)
