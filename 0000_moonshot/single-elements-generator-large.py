...
if __name__ == '__main__':
    ...
    #         matrix[y][x] = matrix[y][x] + offset_matrix[y][x]
            ...
            #     matrix[y][x] = matrix[y][x] + np.array([0, 0, -0.003-0.001])
    #left right
    c1 = cm.gen_box(extent=[.006*18.5, 0.006*12, .001], homomat=rm.homomat_from_posrot([0.006*22, 0.006*11  ,0], rm.rotmat_from_axangle([0,0,1], 0*np.pi/2)),rgba=[0,0,0,0.2])
    c2 = cm.gen_box(extent=[.006*18.5, 0.006*12, .001], homomat=rm.homomat_from_posrot([0.006*22, 0.006*35  ,0], rm.rotmat_from_axangle([0,0,1], 0*np.pi/2)),rgba=[0,0,0,0.2])
    #top down
    c3 = cm.gen_box(extent=[.006*4   , 0.006*36.5, .001], homomat=rm.homomat_from_posrot([0.006*3.5 , 0.006*23,0], rm.rotmat_from_axangle([0,0,1], 0*np.pi/2)), rgba=[0,0,0,0.2])
    c4 = cm.gen_box(extent=[.006 * 4, 0.006 * 36.5, .001], homomat=rm.homomat_from_posrot([0.006 * (33+3.5+4), 0.006 * 23, 0], rm.rotmat_from_axangle( [0, 0, 1], 0 * np.pi / 2)), rgba=[0, 0, 0, 0.2])
    #center
    c5 = cm.gen_box(extent=[.006 * 11, 0.006 * 15, .001], homomat=rm.homomat_from_posrot([0.006 * (17 + 5.5), 0.006 * 7, 0], rm.rotmat_from_axangle([0, 0, 1], 0 * np.pi / 2)), rgba=[0, 0, 0, 0.2])
