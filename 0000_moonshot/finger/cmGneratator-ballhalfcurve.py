...
class Element(object):
    ...
    def get_stl(self, dict):
        ...
        if self.parity == "even-even":
            t1_0_objtrm = self.t1_0.objtrm
            t2_0_objtrm = self.t2_0.objtrm
            t3_0_objtrm = self.t3_0.objtrm
            t1_1_objtrm = self.t1_1.objtrm
            t2_1_objtrm = self.t2_1.objtrm
            t3_1_objtrm = self.t3_1.objtrm
            t1_0_objtrm.export(f"{file}t_0_c1.stl")
            t2_0_objtrm.export(f"{file}t_0_c2.stl")
            t3_0_objtrm.export(f"{file}t_0_c3.stl")
...
if __name__ == '__main__':
    ...
    for item in range(0, n+1):
        ...
        for layer in range(0,height_layer):
            x = np.cos(item * 1 * np.pi / (n - 4)) * r
            z = np.sin(item * 1 * np.pi / (n - 4)) * r
    ...
    for key in matrix_infos.keys():
        element = Element(matrix_infos[key], dict="half",radius=radius, id = key, cut = cut_list, support = False, secondlayer = False)
