...
if __name__ == "__main__":
    ...
    fvsd0_fg_0 = pickle.load(open("../0423-scm-ring/rg_s1_scm_85_10_0.pickle", "rb"))
    fvsd1_fg_0 = pickle.load(open("../0423-scm-ring/rg_s1_scm_85_10_3.pickle", "rb"))
    fvsd2_fg_0 = pickle.load(open("../0423-scm-ring/rg_s1_scm_85_10_4.pickle", "rb"))
    ...
    fvsd0_fg_bos = pickle.load(open("../0423-scm-ring-bothsparse/rg_s1_scm_85_10_1.pickle", "rb"))
    fvsd1_fg_bos = pickle.load(open("../0423-scm-ring-bothsparse/rg_s1_scm_85_10_2.pickle", "rb"))
    fvsd2_fg_bos = pickle.load(open("../0423-scm-ring-bothsparse/rg_s1_scm_85_10_4.pickle", "rb"))

    fvsd0_fg_cms = pickle.load(open("../0423-scm-ring-cmsparse/rg_s1_scm_85_10_0.pickle", "rb"))
    fvsd1_fg_cms = pickle.load(open("../0423-scm-ring-cmsparse/rg_s1_scm_85_10_2.pickle", "rb"))
    fvsd2_fg_cms = pickle.load(open("../0423-scm-ring-cmsparse/rg_s1_scm_85_10_1.pickle", "rb"))

    fvsd0_fg_rgs = pickle.load(open("../0423-scm-ring-ringsparse/rg_s1_scm_85_10_0.pickle", "rb"))
    fvsd1_fg_rgs = pickle.load(open("../0423-scm-ring-ringsparse/rg_s1_scm_85_10_2.pickle", "rb"))
    fvsd2_fg_rgs = pickle.load(open("../0423-scm-ring-ringsparse/rg_s1_scm_85_10_1.pickle", "rb"))
    ...
    case(fvsd0_fg_0, fvsd1_fg_0, fvsd2_fg_0, "red", rate = 8/7)
