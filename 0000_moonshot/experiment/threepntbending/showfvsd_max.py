...
if __name__ == "__main__":
    ...
    fvsd0_fg_0 = pickle.load(open("f_g_85_20_9.pickle", "rb"))
    fvsd1_fg_0 = pickle.load(open("f_g_85_20_5.pickle", "rb"))
    fvsd2_fg_0 = pickle.load(open("f_g_85_20_6.pickle", "rb"))
    fvsd3_fg_0 = pickle.load(open("f_g_85_20_7.pickle", "rb"))
    fvsd4_fg_0 = pickle.load(open("f_g_85_20_8.pickle", "rb"))

    fvsd0_fg_25 = pickle.load(open("f_cm_85_20_0.pickle", "rb"))
    fvsd1_fg_25 = pickle.load(open("f_cm_85_20_1.pickle", "rb"))
    fvsd2_fg_25 = pickle.load(open("f_cm_85_20_2.pickle", "rb"))
    fvsd3_fg_25 = pickle.load(open("f_cm_85_20_3.pickle", "rb"))
    fvsd4_fg_25 = pickle.load(open("f_cm_85_20_4.pickle", "rb"))

    fvsd0_fg_45 = pickle.load(open("b_cm_85_20_4.pickle", "rb"))
    fvsd1_fg_45 = pickle.load(open("b_cm_85_20_5.pickle", "rb"))
    fvsd2_fg_45 = pickle.load(open("b_cm_85_20_6.pickle", "rb"))
    fvsd3_fg_45 = pickle.load(open("b_cm_85_20_7.pickle", "rb"))
    fvsd4_fg_45 = pickle.load(open("b_cm_85_20_8.pickle", "rb"))
