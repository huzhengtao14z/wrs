...
if __name__ == "__main__":
    ...
    fvsd0_fg_0 = pickle.load(open("f_g_0_20_0.pickle", "rb"))
    fvsd1_fg_0 = pickle.load(open("f_g_0_20_1.pickle", "rb"))
    fvsd2_fg_0 = pickle.load(open("f_g_0_20_2.pickle", "rb"))
    fvsd3_fg_0 = pickle.load(open("f_g_0_20_3.pickle", "rb"))
    fvsd4_fg_0 = pickle.load(open("f_g_0_20_4.pickle", "rb"))

    fvsd0_fg_25 = pickle.load(open("f_g_25_20_0.pickle", "rb"))
    fvsd1_fg_25 = pickle.load(open("f_g_25_20_1.pickle", "rb"))
    fvsd2_fg_25 = pickle.load(open("f_g_25_20_2.pickle", "rb"))
    fvsd3_fg_25 = pickle.load(open("f_g_25_20_3.pickle", "rb"))
    fvsd4_fg_25 = pickle.load(open("f_g_25_20_4.pickle", "rb"))

    fvsd0_fg_45 = pickle.load(open("f_g_45_20_0.pickle", "rb"))
    fvsd1_fg_45 = pickle.load(open("f_g_45_20_1.pickle", "rb"))
    fvsd2_fg_45 = pickle.load(open("f_g_45_20_2.pickle", "rb"))
    fvsd3_fg_45 = pickle.load(open("f_g_45_20_3.pickle", "rb"))
    fvsd4_fg_45 = pickle.load(open("f_g_45_20_4.pickle", "rb"))
