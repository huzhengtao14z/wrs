...
if __name__ == "__main__":
    ...
    fvsd0_fg_0 = pickle.load(open("../torque-angle/a90-77-10-3-0.pickle", "rb"))
    fvsd1_fg_0 = pickle.load(open("../torque-angle/a90-77-10-3-1.pickle", "rb"))
    fvsd2_fg_0 = pickle.load(open("../torque-angle/a90-77-10-3-2.pickle", "rb"))
    fvsd3_fg_0 = pickle.load(open("../torque-angle/a90-77-10-3-3.pickle", "rb"))
    fvsd4_fg_0 = pickle.load(open("../torque-angle/a90-77-10-3-4.pickle", "rb"))
