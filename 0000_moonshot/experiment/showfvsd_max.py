...
if __name__ == "__main__":
    ...
    fvsd0_fg_0 = pickle.load(open("0818/b_cm_88_20_0.pickle", "rb"))
    fvsd1_fg_0 = pickle.load(open("0818/b_cm_88_20_1.pickle", "rb"))
    fvsd2_fg_0 = pickle.load(open("0818/b_cm_88_20_2.pickle", "rb"))
    fvsd3_fg_0 = pickle.load(open("0818/b_cm_88_20_3.pickle", "rb"))
    fvsd4_fg_0 = pickle.load(open("0818/b_cm_88_20_4.pickle", "rb"))

    fvsd0_fg_25 = pickle.load(open("0818/b_gs_80_20_7.pickle", "rb"))
    fvsd1_fg_25 = pickle.load(open("0818/b_gs_80_20_4.pickle", "rb"))
    fvsd2_fg_25 = pickle.load(open("0818/b_gs_80_20_5.pickle", "rb"))
    fvsd3_fg_25 = pickle.load(open("0818/b_gs_80_20_6.pickle", "rb"))
    fvsd4_fg_25 = pickle.load(open("0818/b_gs_80_20_7.pickle", "rb"))

    fvsd0_fg_45 = pickle.load(open("0731/f_cm_80_20_0.pickle", "rb"))
    fvsd1_fg_45 = pickle.load(open("0731/f_cm_80_20_1.pickle", "rb"))
    fvsd2_fg_45 = pickle.load(open("0731/f_cm_80_20_2.pickle", "rb"))
    fvsd3_fg_45 = pickle.load(open("0731/f_cm_80_20_3.pickle", "rb"))
    fvsd4_fg_45 = pickle.load(open("0731/f_cm_80_20_4.pickle", "rb"))
