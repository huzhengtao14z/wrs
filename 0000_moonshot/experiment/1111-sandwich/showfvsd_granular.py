...
if __name__ == "__main__":
    ...
    fvsd0_fg_0 = pickle.load(open("p_s2_cm_0_0.pickle", "rb"))
    fvsd1_fg_0 = pickle.load(open("p_s2_cm_0_2.pickle", "rb"))
    fvsd2_fg_0 = pickle.load(open("p_s2_cm_0_1.pickle", "rb"))
    fvsd3_fg_0 = pickle.load(open("p_s2_cm_0_3.pickle", "rb"))
    fvsd4_fg_0 = pickle.load(open("p_s2_cm_0_4.pickle", "rb"))

    fvsd0_fg_25 = pickle.load(open("p_s_cm_1.pickle", "rb"))
    fvsd1_fg_25 = pickle.load(open("p_s_cm_2.pickle", "rb"))
    fvsd2_fg_25 = pickle.load(open("p_s_cm_3.pickle", "rb"))
    fvsd3_fg_25 = pickle.load(open("p_s_cm_4.pickle", "rb"))
    fvsd4_fg_25 = pickle.load(open("p_s_cm_0.pickle", "rb"))

    fvsd0_fg_45 = pickle.load(open("../threepntbending/f_cm_0_20_0.pickle", "rb"))
    fvsd1_fg_45 = pickle.load(open("../threepntbending/f_cm_0_20_1.pickle", "rb"))
    fvsd2_fg_45 = pickle.load(open("../threepntbending/f_cm_0_20_2.pickle", "rb"))
    fvsd3_fg_45 = pickle.load(open("../threepntbending/f_cm_0_20_3.pickle", "rb"))
    fvsd4_fg_45 = pickle.load(open("../threepntbending/f_cm_0_20_4.pickle", "rb"))
    #
    # fvsd0_fg_65 = pickle.load(open("f_g_65_20_0.pickle", "rb"))
    # fvsd1_fg_65 = pickle.load(open("f_g_65_20_1.pickle", "rb"))
    # fvsd2_fg_65 = pickle.load(open("f_g_65_20_2.pickle", "rb"))
    # fvsd3_fg_65 = pickle.load(open("f_g_65_20_3.pickle", "rb"))
    # fvsd4_fg_65 = pickle.load(open("f_g_65_20_4.pickle", "rb"))
    #
    # fvsd0_fg_85 = pickle.load(open("f_g_85_20_9.pickle", "rb"))
    # fvsd1_fg_85 = pickle.load(open("f_g_85_20_5.pickle", "rb"))
    # fvsd2_fg_85 = pickle.load(open("f_g_85_20_6.pickle", "rb"))
    ...
    case(fvsd0_fg_0, fvsd1_fg_0, fvsd2_fg_0, fvsd3_fg_0, fvsd4_fg_0, "red", rate = 8/7)
    case(fvsd0_fg_25, fvsd1_fg_25, fvsd2_fg_25, fvsd3_fg_25, fvsd4_fg_25, "blue", rate = 8/7)
    case(fvsd0_fg_45, fvsd1_fg_45, fvsd2_fg_45, fvsd3_fg_45, fvsd4_fg_45, "gold", rate = 6.5/5)
