...
class ContactDetector():
    def __init__(self, FeatureDetector, show_sample_contact = True):
    ...
    def _get_pcd(self, objpath, sample = "poisson", pcd_num = 10000, neighbour = 50, radius=0.05):
        ...
        self.pcd, ind = pcd.remove_radius_outlier(nb_points=neighbour, radius=radius)
    ...
    def detect_vertex(self, threshold_u = 10, threshold_l = 0.1, r = 0.01, toggle_nb = False, load=False, save=False, show = False):
        ...
        if load:
            ...
            for j in unique_groups:
                ...
                self.vertex_pnt_clustered.append(mean_temp_pnt)
    ...
    def _get_neibour_detect(self, anchor, threshold_u, threshold_l, radius= 0.0025, toggle_nb=False, show=True):
        if toggle_nb:
