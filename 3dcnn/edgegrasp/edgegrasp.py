...
if __name__=='__main__':
    ...
    # obj = cm.CollisionModel(objpath)
    obj = cm.CollisionModel('thickenrightangle.STL')
    ...
    randid = np.random.randint(0, len(temp), size=5)
    ...
    for i in temp:
        ...
        edge_cm = cm.gen_stick(vertices[edge[i][1]], vertices[edge[i][0]], sections=7, thickness=0.003)
