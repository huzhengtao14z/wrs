...
if __name__ == '__main__':
    ...
    Mesh = o3d.io.read_triangle_mesh('p1.stl')
    ...
    gm.gen_pointcloud(pcd1_np, rgbas=[[1, 0, 0, .7]]).attach_to(base)

    Mesh2 = o3d.io.read_triangle_mesh('p2.stl')
    # Mesh.compute_vertex_normals()
    pcd2 = Mesh2.sample_points_poisson_disk(number_of_points=5000)
    # pcd1, ind = pcd1.remove_radius_outlier(nb_points=15, radius=5)
    pcd2_np = vdda.o3dpcd_to_parray(pcd2)

    gm.gen_pointcloud(pcd2_np).attach_to(base)
